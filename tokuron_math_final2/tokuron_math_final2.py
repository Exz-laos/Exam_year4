...
@st.cache_data
def load_image_pairs(data_folder="tokuron_math_final2/Data"):
    """
...
# --- UI Layout ---
st.set_page_config(page_title="tokuron_math_final2フラッシュカード", layout="wide", page_icon="🧮")
...
# --- Main Flashcard Area ---
st.title("🧮 tokuron_math_final2 フラッシュカード")
